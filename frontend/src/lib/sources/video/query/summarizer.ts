...
Include the key points, data, and topics discussed. Keep it concise.
...
export async function mapReduceSummary(
  ...
  const systemPrompt = `You are provided with chronological summaries of different sections of a video transcript.
